...
class AdminWebController extends Controller
{
    public function detail_member($id)
    {
        ...
        // dd($gambarkelas);
        return view('admin-web.detail', compact('detailgambar'));
    }
    public function index()
    {
        $datauser = User::all();
        // dd($datauser);
        return view('admin-web.dashboard-adminweb', compact('datauser'));
    }
    public function cari(Request $request)
    {
        try {
            ...
            $datauser = User::where(function ($query) use ($cari) {
                ...
                $query->where('role','!=', 'adminweb');
            })
                ->get();
            return view('admin-web.dashboard-adminweb', ['datauser' => $datauser]);
        } catch (\Exception $e) {
            return $e->getMessage();
        }
    }
    ...
    {
        $role = User::groupBy('role')->where('role','admin')->orWhere('role','topmanajemen')->get();
        return view('admin-web.add', compact('role'));
    }
    ...
    // peserta kelas
    public function detail_member_peserta_kelas($id)
    {
    ...
    //  * @return \Illuminate\Http\Response
    //  */
    public function edit_peserta_kelas(Kelas $kelas, $id)
    {
    ...
    //  * @return \Illuminate\Http\Response
    //  */
    public function update_peserta_kelas(Request $request, $id)
    {
    ...
    //  * @return \Illuminate\Http\Response
    //  */
    public function destroy_peserta_kelas($id)
    {
        $kelas = Kelas::findOrFail($id);
        Storage::disk('local')->delete('public/gambar_kelas/' . $kelas->gambar_kelas);
        $kelas->delete();
