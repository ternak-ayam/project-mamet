...
class LaporanDataKelasController extends Controller
{
    public function detail_member($id)
    {
        ...
        // dd($users);
        return view('admin.data-kelas.detail', compact('users','data'));
    }
    public function index()
    {
        $datakelas = Kelas::all();
        // dd($datakelas);
        return view('admin.data-kelas.index', compact('datakelas'));
    }
    ...
    //             ->paginate(15);
    //         return view('admin.data-kelas.index', ['gambarkelas' => $gambarkelas]);
    //     } catch (\Exception $e) {
    //         return $e->getMessage();
    //     }
    // }
