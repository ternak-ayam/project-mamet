    ...
    <form action="{{ route('store-gambar-kegiatan-kelas') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            @if ($message = Session::get('error'))
                <div class="alert alert-danger alert-dismissible fade show  col-12 col-md-8 mb-2  "style="margin: 0 auto" role="alert">
        ...
        <div class="row">
            <div class="col-12 col-md-6 mx-auto">
                <div class="row">
                    ...
                    <div class="d-grid gap-1 col-6 col-md-6 ">
                        <a class="btn btn-danger" href="{{ route('gambar-kegiatan-kelas') }}">Kembali </a>
                    </div>
                </div>
            </div>
        </div>
