                ...
                <div class="col-md-12 text-black">
                    ...
                    <form action="{{ route('checkout.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text text-black-50">Mohon Transfer ke rekening  <img style="width: 40px"
                                src="{{ url('/img/bank-jago.png') }}" alt="..." /> 103240606724 A.n I Ketut Slamat Adi Palguna
                            </div>
